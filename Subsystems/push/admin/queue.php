							...
							<div class="box-content nopadding">
								<form action="" method="POST" class='form-horizontal form-bordered'>
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="query" id="textarea" rows="5" class="input-block-level"><?php echo $query ?></textarea>
										</div>
									</div>
									...
									<tbody>
										...
										<tr class="<?php echo $rowClass ?>">
											...
											<td>
												...
												Waited : <strong><?php echo strtotime($row['sent']) - strtotime($row['queued']) ?><strong> sec
											</td>
											<td>
												<button class="btn btn-satgreen detail-btn" rowid="<?php echo $row['id'] ?>"><i class="icon-info-sign"></i> See datail</button><br />
												<button class="btn btn-grey send-btn" rowid="<?php echo $row['id'] ?>"><i class="icon-circle-arrow-right"></i> Send again</button>
											</td>
